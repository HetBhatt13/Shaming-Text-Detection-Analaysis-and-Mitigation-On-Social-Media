...
def WritePredictedData(id,InputData,aa,religious, abusive, comparative,passingjudgement,db=db):
        cur = db.cursor() 
        query="insert into tbl_records(userid, text, label, religious, abusive, comparative,passingjudgement) values(%s,%s,%s,%s,%s,%s,%s)"
        value=[id,InputData,aa,religious, abusive, comparative,passingjudgement]
        cur.execute(query,value)
        db.commit()  
